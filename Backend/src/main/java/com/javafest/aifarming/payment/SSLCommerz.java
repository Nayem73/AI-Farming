...
import com.javafest.aifarming.payment.parametermappings.SSLCommerzInitResponse;
import com.javafest.aifarming.payment.parametermappings.SSLCommerzValidatorResponse;
import com.javafest.aifarming.payment.utility.ParameterBuilder;
import com.javafest.aifarming.payment.utility.Util;
...
public class SSLCommerz {
    ...
    private void setSSLCzTestMode(boolean storeTestMode) {
        ...
        if (storeTestMode) {
             this.storeId = "aifar64ea1f7a8c3ec";
             this.storePass = "aifar64ea1f7a8c3ec@ssl";
